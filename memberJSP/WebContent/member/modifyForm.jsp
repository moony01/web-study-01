...
<tr>
	<th width="80">이름</th>
	<td><input type="text" name="name" id="name" value="<%= memberDTO.getName() %>"></td>
</tr>
<tr>
	<th width="80">아이디</th>
	<td>
		<input type="text" name="id" value="<%= memberDTO.getId() %>" style="width: 200px;" readonly>
	</td>
</tr>
<tr>
	<th width="80">비밀번호</th>
...
<tr>
	<th width="80">이메일</th>
	<td>
		<input type="text" name="email1" value="<%= memberDTO.getEmail1() %>" style="width: 150px;">
		@
...
<tr>
	...
	<td>
		...
		<input type="text" name="addr1" id="daum_addr1" value="<%= memberDTO.getAddr1() %>" style="width: 350px;" placeholder="주소" readonly><br>
		<input type="text" name="addr2" id="daum_addr2" value="<%= memberDTO.getAddr2() %>" style="width: 350px;" placeholder="상세 주소">
	</td>
</tr>
<tr>
